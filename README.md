...
to calculate the extended ROI of AI ethics investments over multiple years. This program, which you can try [here](https://ibm.github.io/original-source/hroe.html), prompts users for inputs
